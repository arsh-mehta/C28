...
function setup() {
	...
	mango1 = new Mango(1300,300,35);
	mango2 = new Mango(1350,250,35);
	mango3 = new Mango(1300,200,35);
	mango4 = new Mango(1390,300,35);
	mango5 = new Mango(1300,300,35);
	mango6 = new Mango(1200,300,35);
  mango7 = new Mango(1500,280,35);
